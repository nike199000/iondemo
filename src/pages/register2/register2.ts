...
this.lo1 = true;
  ...
  verify2(cardnumber){
       ...
       this.clientcompanyData = this.httpClient.get('http://api.igiinsurance.com.pk:8888/insurance_IgiGen/insurance-api/get_company_employee.php?offset=0&limit=40000',
                       {
                          params: {
...
this.http2.get('http://outreach.pk/api/sendsms.php/sendsms/url?id=rchiginsurance&pass=igi123456&mask=IGInsurance&lang=English&type=xml', {msg: this.mee, to: this.mobile.value}, {});
       console.log(this.number);
       console.log(this.mobile.value);
